<?php 
        ...
        if(isset($_POST['loginbttn'])){
            ...
            $result=mysqli_query($con,'select * from loginform where user="'.$uname.'" and pass="'.$pass.'"');
            if(mysqli_num_rows($result)==1)
            {
                $_SESSION['uname']=$uname;
                echo "<script>alert('you have Successfully Logged In');location.href='admin.php'</script>";
...
.a1{
    ...
    <body alink="red" vlink="aqua">
        ...
        <div class="bg-text">
        <h1>Welcome to Admin Login page for SCET Portal</h1>
        <form method="post" action="#">
            <table align=center style="font-size: 30;">
                ...
                <tr>
                    <td><input type="submit" name='loginbttn' class="a1" style="font-size:20px;"></td>
                    <td><button type="reset" style="font-size:20px;" class="a2">Reset</button></td>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
